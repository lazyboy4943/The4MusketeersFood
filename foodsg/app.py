...
# Flask app under this line


names = ['Prakamya', 'Praneeth', 'Pratyush', 'Rahul']



sellers = {
    # id, name, cuisine, availability, vergetarian
    1: {"name": "Wong", "cuisine": "Assorted", "foodavailable": True, "vegetarian": True},
    2: {"name": "Lee", "cuisine": "Assorted", "foodavailable": True, "vegetarian": True},
    3: {"name": "Suresh", "cuisine": "Indian", "foodavailable": True, "vegetarian": True},
    4: {"name": "Wong", "cuisine": "Chinese", "foodavailable": True, "vegetarian": True},
    5: {"name": "Chan", "cuisine": "Assorted", "foodavailable": True, "vegetarian": False},
}
...
def listings(): 
    ...
    # recommendedsellers is a list
    print("list: ", recommendedsellers)
